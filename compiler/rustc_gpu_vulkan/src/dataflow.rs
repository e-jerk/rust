...
impl<'ctx> GpuDataflowEngine<'ctx> {
    ...
    /// Dispatch one dominance analysis round.
    ///
    /// Iteratively refines dominator sets until convergence.
    ...
    /// Dispatch loop detection kernel.
    ///
    /// Computes transitive closure of CFG and identifies loop headers.
    ...
    /// Dispatch GVN (Global Value Numbering) kernel.
    ///
    /// Assigns value numbers to expressions based on their hashes.
    ...
    /// Dispatch induction variable detection kernel.
    ///
    /// Identifies loop variables that are incremented/decremented by constants.
    ...
    /// Dispatch mega-batch dataflow kernel.
    ///
    /// Processes N functions simultaneously in one GPU dispatch.
    ...
    pub fn dispatch_mega_batch_round(
        ...
        unsafe {
            ...
            // Dispatch: local_size_x = 256
            // Each workgroup processes blocks_per_workgroup blocks per function
    ...
    /// Dispatch graph partitioning kernel.
    ///
